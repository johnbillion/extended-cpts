...
class Extended_CPT {
	 ...
	 * Class constructor.
	 *
	 * The $post_type parameter is used as the post type name and to build the post type labels. This means you can
	 * create a post type with just one parameter and all labels and post updated messages will be generated for you.
	 * Example:
	 *
	 *     register_extended_post_type( 'event' );
	 *
	 * The plural name for a post type is generated by appending an 's' to $post_type. The post type slug is generated
	 * from the plural. The singular name is the same as the $post_type parameter. These can be overridden with the
